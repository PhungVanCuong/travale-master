                ...
                <div class="card mb-4 mb-xl-0">
                    ...
                    <div class="card-body text-center">
                        <img id="avatarPreview" class="img-account-profile rounded-circle mb-2"
                            src="{{ asset('admin/assets/images/user-profile/default.jpg') }}"
                    ...
                    <div class="card-body">
                        <form action="{{ route('update-user-profile') }}" method="POST" name="updateUser" class="updateUser">
                            ...
                            <div class="row gx-3 mb-3">
                                <div class="col-md-12">
                                    <label class="small mb-1" for="inputFullName">Tên đăng nhập (Username)</label>
                            ...
                            <div class="row gx-3 mb-3">
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" id="inputLocation" type="text" name="address" placeholder="Địa chỉ"
                            ...
                            <div class="row gx-3 mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="inputPhone" type="text" name="phoneNumber"
