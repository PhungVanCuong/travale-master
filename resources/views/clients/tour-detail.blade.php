        ...
        <div class="row gap-10 justify-content-center rel">
            <div class="col-lg-4 col-md-6">
                <div class="gallery-item">
                    <img src="{{ asset('admin/assets/images/gallery-tours/' . (isset($tourDetail->images[0]) ? $tourDetail->images[0]->imageURL : 'default.jpg')) }}"
                        alt="Destination">
                </div>
                <div class="gallery-item">
                    <img src="{{ asset('admin/assets/images/gallery-tours/' . (isset($tourDetail->images[1]) ? $tourDetail->images[1]->imageURL : 'default.jpg')) }}"
                        alt="Destination">
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="gallery-item gallery-between">
                    <img src="{{ asset('admin/assets/images/gallery-tours/' . (isset($tourDetail->images[2]) ? $tourDetail->images[2]->imageURL : 'default.jpg')) }}"
                        alt="Destination">
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="gallery-item">
                    <img src="{{ asset('admin/assets/images/gallery-tours/' . (isset($tourDetail->images[3]) ? $tourDetail->images[3]->imageURL : 'default.jpg')) }}"
                        alt="Destination">
                </div>
                <div class="gallery-item">
                    <img src="{{ asset('admin/assets/images/gallery-tours/' . (isset($tourDetail->images[4]) ? $tourDetail->images[4]->imageURL : 'default.jpg')) }}"
                        alt="Destination">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="accordion-two mt-25 mb-60" id="faq-accordion-two">
                    @php $day = 1; @endphp
                    @if(isset($tourDetail->timeline))
                        @foreach ($tourDetail->timeline as $timeline)
                            <div class="accordion-item">
                                <h5 class="accordion-header">
                                    <button class="accordion-button collapsed" data-bs-toggle="collapse"
                                        data-bs-target="#collapseTwo{{ $timeline->id ?? $loop->index }}">
                                        Ngày {{ $day++ }} - {{ $timeline->day ?? 'Lịch trình' }}
                                    </button>
                                </h5>
                                <div id="collapseTwo{{ $timeline->id ?? $loop->index }}" class="accordion-collapse collapse"
                        ...
                        <div class="widget widget-tour" data-aos="fade-up" data-aos-duration="1500"
                            ...
                            @foreach ($tourRecommendations as $tour)
                                <div class="destination-item tour-grid style-three bgc-lighter">
                                    <div class="image">
                                        <img src="{{ asset('admin/assets/images/gallery-tours/' . (isset($tour->images[0]) ? $tour->images[0]->imageURL : 'default.jpg')) }}"
